...
final class SettingViewModel {
    ...
    func setSettingList() {
        ...
        list.value = [Setting(title: "서비스 이용 약관", subTitle: nil, detail: nil),
                      Setting(title: "문의하기", subTitle: nil, detail: nil),
                      Setting(title: "리뷰남기기", subTitle: nil, detail: nil),
                      Setting(title: "개발자 정보", subTitle: nil, detail: nil),
                      Setting(title: "오픈소스 라이선스 보기", subTitle: nil, detail: nil),
                      Setting(title: "앱 버전", subTitle: "\(currentVersion)", detail: versionDescription)]
    }
